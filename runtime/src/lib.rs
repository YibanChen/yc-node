...
/// Add this code block to your template for Name Service / Nick Names:
parameter_types! {
  // Choose a fee that incentivizes desireable behavior.
  pub const NickReservationFee: u128 = 1_000_000_000_000;
...
construct_runtime!(
        ...
        UncheckedExtrinsic = UncheckedExtrinsic
    {
        ...
        NameService: pallet_name_service::{Pallet, Call, Storage, Event<T>},
    }
);
